...
from codesys_utils import (
    ...
    calculate_hash, format_st_content, MetadataLock
)
...
def sync_check():
    ...
    # Singleton check within the same process
    ...
    try:
        ...
        # Use file-based lock for cross-script safety
        with MetadataLock(base_dir):
